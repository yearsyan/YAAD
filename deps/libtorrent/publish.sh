...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <name>libtorrent Android for YAAD</name>
    <description>libtorrent library for YAAD</description>
    <url>https://github.com/yearsyan/YAAD/tree/main/deps/libtorrent</url>
    <licenses>
        <license>
    ...
    <scm>
        <connection>scm:git:git://github.com/${GITHUB_REPOSITORY:-yearsyan/YAAD}.git</connection>
        <developerConnection>scm:git:ssh://github.com/${GITHUB_REPOSITORY:-yearsyan/YAAD}.git</developerConnection>
        <url>https://github.com/${GITHUB_REPOSITORY:-yearsyan/YAAD}</url>
    </scm>
</project>
EOF
